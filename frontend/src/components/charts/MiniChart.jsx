...
const CustomTooltip = ({ active, payload, label, prefix = '', suffix = '' }) => {
  ...
  return (
    <div className="px-3 py-2 rounded-xl glass shadow-xl border border-white/10" style={{ background: 'rgba(15, 15, 26, 0.9)', backdropFilter: 'blur(12px)' }}>
      <div className="text-text-dim mb-1 font-bold uppercase tracking-wider text-[10px]">{label}</div>
      {payload.map((p, i) => (
