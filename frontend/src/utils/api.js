...
export const mockDashboard = {
  ...
  RecentDecisions: [
    { Id: 1, Section: 'Products', DecisionType: 'PriceDecrease', ItemName: 'Wireless Mouse Pro', DecisionDetails: 'Price reduced from Rs 34.99 to Rs 29.99', CreatedAt: new Date().toISOString(), Status: 'Applied' },
    ...
    { Id: 5, Section: 'Returns', DecisionType: 'Approve', ItemName: 'RTN-00234', DecisionDetails: 'Return approved, refund of Rs 89.99', CreatedAt: new Date(Date.now() - 14400000).toISOString(), Status: 'Applied' },
  ],
  Alerts: [
...
export const mockRules = [
  ...
  { Id: 5, Category: 'Customer', RuleName: 'VIP Tier', CurrentValue: '5000', DefaultValue: '5000', Description: 'Auto VIP if total spent > Rs', IsEditable: true },
  { Id: 6, Category: 'Customer', RuleName: 'Gold Tier', CurrentValue: '2000', DefaultValue: '2000', Description: 'Auto Gold if total spent > Rs', IsEditable: true },
  ...
  { Id: 9, Category: 'RTO', RuleName: 'High Value Penalty', CurrentValue: '20', DefaultValue: '20', Description: 'Points added if order value >Rs 500', IsEditable: true },
